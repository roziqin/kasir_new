...
if($_GET['ket']=='tambahmenu'){
	...
	if ($data['barang_set_stok']==1 && $jml>$data['barang_stok']) {
		...
		$sql = "INSERT INTO transaksi_detail_temp(transaksi_detail_temp_barang_id,transaksi_detail_temp_harga,transaksi_detail_temp_jumlah,transaksi_detail_temp_total,transaksi_detail_temp_keterangan,transaksi_detail_temp_user)values('$id','$harga','$jumlah','$tot','$ket','$user')";
		//$array_datas[] = ["Ok"];
